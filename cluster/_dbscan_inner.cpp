...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/home/jyzhao/.local/lib/python3.7/site-packages/numpy/core/include/numpy/arrayobject.h",
            "/home/jyzhao/.local/lib/python3.7/site-packages/numpy/core/include/numpy/ufuncobject.h"
        ],
        "include_dirs": [
            "/home/jyzhao/.local/lib/python3.7/site-packages/numpy/core/include"
        ],
        "language": "c++",
...
static CYTHON_INLINE void __pyx_f_7sklearn_7cluster_13_dbscan_inner_push(std::vector<npy_intp>  &__pyx_v_stack, npy_intp __pyx_v_i) {
  ...
  /* "sklearn/cluster/_dbscan_inner.pyx":16
 * # a cdef function with an "except +" declaration.
 * cdef inline void push(vector[np.npy_intp] &stack, np.npy_intp i) except +:
 *     stack.push_back(i)             # <<<<<<<<<<<<<<
 * 
 ...
 *                  np.ndarray[np.npy_intp, ndim=1, mode='c'] labels):
 */
  __pyx_tuple__8 = PyTuple_Pack(8, __pyx_n_s_is_core, __pyx_n_s_neighborhoods, __pyx_n_s_labels, __pyx_n_s_i, __pyx_n_s_label_num, __pyx_n_s_v, __pyx_n_s_neighb, __pyx_n_s_stack); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(3, 0, 8, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_sklearn_cluster__dbscan_inner_py, __pyx_n_s_dbscan_inner, 19, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
